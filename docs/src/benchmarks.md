...
The benchmarking scripts, raw data, and detailed results are available [here](https://github.com/NicolasL-S/SpeedMapping.jl/tree/main/docs/benchmarking_code).
